// Kopiere den gesamten <script> aus der ersten Version hier rein
// (die onload-Funktion, generateFullTable usw.)
...
window.onload = function() {
    <script>
        ...
        const baseData = [
            ...
            // ... (we will fill the rest dynamically)
        ];
        ...
        function generateFullTable() {
            ...
            for (let i = 0; i < 60; i++) {
                ...
                // Trend simulation (hot start, then slight cooling)
                let trend = "+";
                if (i > 45) trend += "0.5";
                else if (i > 30) trend += "1.2";
                else trend += "2.8";

                // Rain % (mostly low in first 45 days)
        ...
        function loadTodayData() {
            ...
            setTimeout(() => {
                ...
                // Optional: add a small confetti effect (demo)
                createConfetti();
            }, 1200);
        }
        ...
        function acceptAllCookies() {
            ...
            // In real app: set cookie with 1 year expiration
        }
